...
def main():
    ...
    for i in range(100):
        list_of_objects.append(next(result_dict))
    ...
    while True:
        result_dict = {
            ...
            'fields': {
                ...
                'author': [
                    author(authors=['Alex', 'Jhon', 'Luci']), author(authors=['Michael', 'Aria', 'Lamar'])
                ],
...
def add_fields_rating_to_dict(max_value=5) -> float:
    """
...
def add_fields_price_to_dict(min_price=10, max_price=10000) -> int:
    """
